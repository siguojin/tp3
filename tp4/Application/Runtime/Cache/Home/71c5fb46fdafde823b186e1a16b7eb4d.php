                ...
                <div class="shop_bd_top_center">
                    ...
                    <div class="xifan_sub_box">
                      ...
                      <div id="xifan_bd1lfimg">
                        <div>
                          <dl class=""></dl>
                          <?php if(is_array($info)): foreach($info as $k=>$v): ?><dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank">
                            <img src="/Uploads/<?php echo ($v["files"]); ?>" alt="2011城市主题公园亲子游"></a>
                            </dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a></h2>
                            </dd>
                    ...
                    <div class="tuijian_content">
                        <div id="tuijian_content_1" class="tuijian_shangpin" style="display: block;">
                            <ul>
                                <li>
                                    <dl>
                                    <?php if(is_array($infos)): foreach($infos as $k=>$v): ?><dt><a href="U('add')"><img src="/Uploads/<?php echo ($v["image"]); ?>" /></a></dt>
                                        <dd><a href=""><?php echo ($v["shopname"]); ?></a></dd>
                                        <dd> 商城价：<em><?php echo ($v["model"]); ?></em>元</dd><?php endforeach; endif; ?>
                                    </dl>
                                </li>
                        <!--         <li>
                                    <dl>
                                        <dt><a href=""><img src="/Public/lunbo/images/365_7d5e08127b8d6799209674ecffbfc624.jpg_small.jpg" /></a></dt>
