...
<title>haoyun-DouPHP 管理中心 - 导航管理 </title>
...
<!-- dcHead 结束 -->
 ...
 <ul class="top">
  <li><a href="index.html"><i class="home"></i><em>PHP1804A</em></a></li>
 </ul>
 <ul>
  <li><a href="system.html"><i class="system"></i><em>全体100</em></a></li>
  ...
  <li><a href="manager.html"><i class="manager"></i><em>导航管理</em></a></li>
  <li><a href="manager_log.html"><i class="managerLog"></i><em>操作记录</em></a></li>
 </ul>
</div></div>
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>导航管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="manager.html" class="actionBtn">返回列表</a>导航管理</h3>
