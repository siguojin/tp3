...
<head>
	...
	<link rel="stylesheet" href="/Public/lunbo/css/shop_gouwuche.css" type="text/css" />
    ...
    <script type="text/javascript" src="/Public/lunbo/js/jquery.goodnums.js" ></script>
    <script type="text/javascript" src="/Public/lunbo/js/shop_gouwuche.js" ></script>
</head>
<body>
		...
		<div class="shop_gwc_bd_contents clearfix">
			...
			<table>
				...
				<tbody>
						...
						<td class="gwc_list_pic"><a href=""><img src="\Uploads\<?php echo ($vo["image"]); ?>" width="50px" height="50px" />
						</a></td>
						<td class="gwc_list_title"><a href=""><?php echo ($vo["shopname"]); ?> </a></td>
						...
						<input type="text" value="1" id="goods_001" class="good_nums" />
					...
					<tr>
						<td colspan="6">
							...
							<div class="gwc_foot_links">
								...
								<a href="#" class="op" onclick='qw()'>确认并填写订单</a>
							</div>
						</td>
					</tr>
				</tfoot>
