...
<head>
	...
	<title>用户登录</title>
	<link rel="stylesheet" href="/Public/lunbo/css/base.css" />
	<link rel="stylesheet" href="/Public/lunbo/css/global.css" />
	<link rel="stylesheet" href="/Public/lunbo/css/login-register.css" />
...
<body>
	...
	<div class="header wrap1000">
		<a href=""><img src="/Public/lunbo/images/logo.png" alt="" /></a>
	</div>
	...
	<div class="main">
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="" method="POST">
					...
					<dl>
						<dt>验证码</dt>
						<dd><input type="text" name="code" class="text" size="10" style="width:58px;"> <img src="<?php echo U('code');?>" alt="" align="absmiddle" style="position:relative;top:-2px;" width="150px" height="60px" /> <a href="" style="color:#999;">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
		...
		<div class="login-form-left fl">
			<img src="/Public/lunbo/images/left.jpg" alt="" />
		</div>
	</div>
