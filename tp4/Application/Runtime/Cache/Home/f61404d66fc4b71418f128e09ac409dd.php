                ...
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                      <input type="text" name="user"  placeholder="分类名" >
                      头像：<input type="file" name="files" placeholder="头像" >
                    </div>
                ...
                <tbody id="x-link">
                 <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="删除" href="<?php echo U(delete,array('id'=>$vo['id']));?>" onclick="cate_del(this,'1')" 
