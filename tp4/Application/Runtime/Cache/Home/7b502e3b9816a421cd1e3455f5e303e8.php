...
<!-- dcHead 结束 -->
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">DouPHP 管理中心<b>></b><strong>FN管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="<?php echo u('category_add');?>" class="actionBtn">返回列表</a>分类管理</h3>
            <form action="<?php echo U('show');?>" method="post">
      ...
      <input type="hidden" name="status" value="0">
       ...
       <td>
        <select name="pid" class="inpMain">
          ...
          <?php if(is_array($info)): foreach($info as $k=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"  <?php if($id==$vo['id']){ echo "selected"; } ?>  > <?php echo str_repeat('|-',$vo['fid']); echo ($vo["type_name"]); ?></option><?php endforeach; endif; ?>
        </select>
       </td>
      </tr>
      <tr>
       ...
       <td>
        <input type="text" name="number" size="40" class="inpMain" />
       </td>
      </tr>
