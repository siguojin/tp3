...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="/Public/css/zy.all.css" />
	...
	<div class="am-cf admin-main" style="padding-top: 0px;">
		...
		<div class="admin-content">
			<div class="admin-content-body">
				<form action="<?php echo U('add');?>" method="post">				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
						...
						<form class="am-form am-form-horizontal"
							...
							<div class="am-form-group">
								...
								分类</label>
								<div class="am-u-sm-9">
									<select name="fen" required id="fen">
										<option value="">请选择分类</option>
										<option value="手机">手机</option>
										<option value="手机">电脑</option>
										<option value="手机">汽车</option>
							...
							商品名称</label>
								<div class="am-u-sm-9">
									<select name="ming" required id="ming">
							...
							<div class="am-form-group">
								<div class="am-u-sm-9 am-u-sm-push-3">
									<input type="submit"  value="添加分类" onclick="qw()" />
								</div>
							</div>
						</form>
					</div>
		...
		<!-- content end -->
			 ...
			 <script src="/Public/js/jquery-1.7.2.min.js" type="text/javascript"></script>
              <script src="/Public/js/plugs/Jqueryplugs.js" type="text/javascript"></script>
              <script src="/Public/js/_layout.js"></script>
             <script src="/Public/js/plugs/jquery.SuperSlide.source.js"></script>
			<script>
