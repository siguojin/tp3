...
<head>
	...
	<link rel="stylesheet" href="/Public/lunbo/css/shop_list.css" type="text/css" />
    <link rel="stylesheet" href="/Public/lunbo/css/shop_goods.css" type="text/css" />
    ...
    <script type="text/javascript" src="/Public/lunbo/js/shop_goods.js" ></script>
</head>
<body>
	...
	<div class="shop_goods_bd clear">
		...
		<div class="shop_goods_show">
			<div class="shop_goods_show_left">
				<!-- 京东商品展示 -->
				<link rel="stylesheet" href="/Public/lunbo/css/shop_goodPic.css" type="text/css" />
				<script type="text/javascript" src="/Public/lunbo/js/shop_goodPic_base.js"></script>
				<script type="text/javascript" src="/Public/lunbo/js/lib.js"></script>
				<script type="text/javascript" src="/Public/lunbo/js/163css.js"></script>
				<div id="preview">
					<div class=jqzoom id="spec-n1" onClick="window.open('/')">
					<IMG height="350" src="/Uploads/<?php echo ($info['image'][0]); ?>" jqimg="/Uploads/<?php echo ($info['image'][0]); ?>" width="350">
						</div>
						<div id="spec-n5">
							<div class=control id="spec-left">
								<img src="/Public/lunbo/images/left.gif" />
							</div>
							<div id="spec-list">
								<ul class="list-h">
								<?php if(is_array($info["image"])): foreach($info["image"] as $key=>$vs): ?><li>
									<img src="/Uploads/<?php echo ($vs); ?>" alt="" width="50" />
									</li><?php endforeach; endif; ?>
								</ul>
							</div>
							<div class=control id="spec-right">
								<img src="/Public/lunbo/images/right.gif" />
							</div>
			...
			<div class="shop_goods_show_right">
				<ul>
					<li>
						<strong style="font-size:14px; font-weight:bold;"><?php echo ($info["shopname"]); ?></strong>
					</li>
					<li>
						<label>价格：</label>
					...
					<li style="padding:20px 0;">
						<label>&nbsp;</label>
						<!-- 隐藏域 -->
						<input type="hidden"  value="<?php echo ($info["shopid"]); ?>" id="shopid"/>
						<span><a href="#" class="goods_sub goods_sub_gou"
						 onclick="qwe(<?php echo ($info["shopid"]); ?>)">加入购物车</a></span>
					</li>
				</ul>
			</div>
				...
				<div class="contents clearfix">
					<ul class="clearfix">
						...
						<li class="clearfix">
							...
							<div class="goods_pic"><span class="goods_price">¥ 279.00 </span><a href=""><img src="/Public/lunbo/images/89a6d6466b00ae32d3c826b9ec639084.jpg_small.jpg" /></a></div>
		...
		<!-- 商品详情 -->
		<script type="text/javascript" src="/Public/lunbo/js/shop_goods_tab.js"></script>
...
<script>
	...
	function qwe(a){
		...
		// 数量id
		var sid=document.getElementById('good_nums').value;
		$.ajax({
			type:'POST',
			url:"<?php echo U('bdd');?>",
			data:{
			...
			success:function(a){
				...
				if(a==1){
					alert("用户未登录，正在跳转登录");
					window.location.href="<?php echo U('Zhuce/login');?>";
				...
				if(a==3){
					alert("加入购物车失败");
					window.location.href="<?php echo U('hoods');?>";
				}
			}
