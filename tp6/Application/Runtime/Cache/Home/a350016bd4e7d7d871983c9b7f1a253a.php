...
<div id="urHere">DouPHP 管理中心<b>></b><strong>网站管理员</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="<?php echo U('Category/show');?>" class="actionBtn">添加分类</a>网站管理员</h3>
     ...
     <?php if(is_array($info)): foreach($info as $k=>$vo): ?><tr>
                  <td align="center"><input type="checkbox" ><?php echo ($vo["id"]); ?></td>
                  <td><?php echo ($vo["type_name"]); ?></td>
                  <td align="center"><?php echo ($vo["fid"]); ?></td>
                  <td align="center"><?php echo ($vo["bumber"]); ?></td>
                  <td align="center"></a><a href="<?php echo U('show',array('id'=>$vo['id']));?>">添加分类|</a><a href="<?php echo U('update',array('id'=>$vo['id']));?>">编辑</a> | <a href="<?php echo U('delete',array('id'=>$vo['id']));?>">删除</a></td>
