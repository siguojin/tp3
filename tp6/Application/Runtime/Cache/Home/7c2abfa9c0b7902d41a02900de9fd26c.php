  ...
  <div class="nav">
   <ul>
    <li class="M"><a href="JavaScript:void(0);" class="topAdd">新建</a>
     <div class="drop mTopad"><a href="product.php?rec=add">商品</a> <a href="article.php?rec=add">文章</a> <a href="nav.php?rec=add">自定义品牌</a> <a href="show.html">首页幻灯</a> <a href="page.php?rec=add">单页面</a> <a href="manager.php?rec=add">管理员</a> <a href="link.html"></a> </div>
    </li>
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <ul>
  ...
  <li><a href="nav.html"><i class="nav"></i><em>自定义品牌栏</em></a></li>
  ...
  <li><a href="manager.html"><i class="manager"></i><em>品牌管理</em></a></li>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>品牌管理</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="manager.html" class="actionBtn">返回列表</a>品牌管理</h3>
            <form action="<?php echo U('insert_demo');?>" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <input type="hidden" name="status" value="1">
        <tr>
       <td width="100" align="right">选择分类</td>
       <td>
        <select name="pid" class="inpMain">
          <option value="0">顶级权限</option>
          <?php if(is_array($info)): foreach($info as $k=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"> <?php echo str_repeat('|-',$vo['level']); echo ($vo["type_name"]); ?></option><?php endforeach; endif; ?>
        </select>
       </td>
      </tr>
      <tr>
