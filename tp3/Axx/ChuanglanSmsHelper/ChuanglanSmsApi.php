...
class ChuanglanSmsApi {
	...
	const API_VARIABLE_URL ='https://smssh1.253.com/msg/send/json';//创蓝变量短信接口URL
	
	const API_BALANCE_QUERY_URL='https://smssh1.253.com/msg/send/json';//创蓝短信余额查询接口URL
	
	const API_ACCOUNT= 'N6664837'; // 创蓝API账号
	
	const API_PASSWORD= '123456aaabbb';// 创蓝API密码
