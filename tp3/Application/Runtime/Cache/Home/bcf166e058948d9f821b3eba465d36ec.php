  ...
  <div class="nav">
   <ul>
    <li class="M"><a href="JavaScript:void(0);" class="topAdd">新建</a>
     <div class="drop mTopad"><a href="product.php?rec=add">商品</a> <a href="/Public/article.php?rec=add">文章</a> <a href="nav.php?rec=add">自定义导航</a> <a href="show.html">首页幻灯</a> <a href="page.php?rec=add">单页面</a> <a href="manager.php?rec=add">管理员</a> <a href="link.html"></a> </div>
    </li>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>网站管理员</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <h3><a href="manager.html" class="actionBtn">返回列表</a>用户[管理员</h3>
     ...
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" name="user" size="40" class="inpMain" />
       </td>
      </tr>
       <tr>
      ...
      <tr>
       ...
       <td>
            ...
            <?php if(is_array($info)): foreach($info as $key=>$v): ?><input type="checkbox" name="role_name[]" size="40"  value="<?php echo ($v["rid"]); ?>"/><?php echo ($v["role_name"]); ?>&nbsp;&nbsp;<?php endforeach; endif; ?>
       </td>
      </tr>
      <tr>
       <td></td>
