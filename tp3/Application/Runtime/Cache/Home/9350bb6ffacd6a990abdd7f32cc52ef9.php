...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<a class="btn btn-primary radius" onclick="system_category_add('添加资讯','system-category-add.html')" href="<?php echo U('bdd');?>"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a>
		</span>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php if(is_array($info)): foreach($info as $key=>$vo): ?><tr class="text-c">
					...
					<td class="f-14"><a title="编辑" href="<?php echo U('update',array('id'=>$vo['id']));?>" onclick="system_category_edit('栏目编辑','system-category-add.html','1','700','480')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
