...
<html lang="en">
 ...
 <link type="text/css" rel="stylesheet"  href="/Public/cd/css/web.css">
 </head>
 <body>
...
<div id="TopMain">
	<!-- 广告开始 -->
	 <div id="topAdv"> 
		<a href="#"> <img src="/Public/cd/images/adv.jpg" /> </a> 
		<img src="/Public/cd/images/close.png"  class="close"/>
	 </div>
	<!-- 广告结束-->  
...
<div id="webIntro">
	<div class="webIntroCon">
		<!--热点推荐开始-->
		<div class="hotIntro">
			<img src="/Public/cd/images/webintro.jpg"  class="hotimg"/>
			<div class="hotList">
				<dl>
					<dt><a href="goods.html" target="_blank"><img src="/Public/cd/images/webpic1.jpg" /></a></dt>
					<dd class="ti">味多美 生日聚会送礼 水果蛋糕 缤纷盛果</dd>
					<dd class="money">特价：<font>￥190.0</font></dd>
					<dd class="buy"><a href="">立即抢购</a></dd>
				</dl>
				<dl>
					<dt><a href="goods.html" target="_blank"><img src="/Public/cd/images/webpic2.jpg" /></a></dt>
					<dd class="ti">味多美 生日聚会送礼 水果蛋糕 缤纷盛果</dd>
					<dd class="money">特价：<font>￥190.0</font></dd>
					<dd class="buy"><a href="">立即抢购</a></dd>
				</dl>
				<dl>
					<dt><a href="goods.html" target="_blank"><img src="/Public/cd/images/webpic3.jpg" /></a></dt>
					<dd class="ti">味多美 生日聚会送礼 水果蛋糕 缤纷盛果</dd>
					<dd class="money">特价：<font>￥190.0</font></dd>
					<dd class="buy"><a href="">立即抢购</a></dd>
				</dl>
		...
		<!--促销活动开始-->
		<div class="newIntro">
			<img src="/Public/cd/images/commintro.jpg"  class="imgNew" />
			<ul>
...
<div id="ProductList">
	...
	<ul>
		<li>
			<img src="/Public/cd/images/dg_img1.jpg" width='200' height="200" />
			<h3>趴趴熊-音乐枕</h3>
			<p><span>￥258.00</span><a href="">立即购买</a></p>
			<p>本产品售销量：<font>400</font></p>
		</li>
		<li>
			<img src="/Public/cd/images/dg_img2.jpg" width='200' height="200" />
			<h3>趴趴熊-音乐枕</h3>
			<p><span>￥258.00</span><a href="">立即购买</a></p>
			<p>本产品售销量：<font>400</font></p>
		</li>
		<li>
			<img src="/Public/cd/images/dg_img3.jpg" width='200' height="200" />
			<h3>趴趴熊-音乐枕</h3>
			<p><span>￥258.00</span><a href="">立即购买</a></p>
			<p>本产品售销量：<font>400</font></p>
		</li>
		<li>
			<img src="/Public/cd/images/dg_img6.jpg" width='200' height="200" />
			<h3>趴趴熊-音乐枕</h3>
			<p><span>￥258.00</span><a href="">立即购买</a></p>
			<p>本产品售销量：<font>400</font></p>
		</li>
...
<!--网站底部开始-->
<img src="/Public/cd/images/f.jpg"  class="fbg"/>
<div id="Footer2">
	<dl class="first">
		<dt><a href="#">关于我们</a></dt>
		<dd><a href="#">诚聘英才</a></dd>
	...
	<dl class="last">
		<dt>客服在线</dt>
		<dd>4006-600-000</dd>
		<dd><img src="/Public/cd/images/QQ.jpg" /></dd>
	</dl>
