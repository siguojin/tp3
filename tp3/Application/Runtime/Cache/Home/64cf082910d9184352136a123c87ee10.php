			...
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<select  name="names" value="<?php echo ($info["names"]); ?>">
						<option value="0">顶级分类</option>
						<?php if(is_array($list)): foreach($list as $key=>$v): ?><option value="<?php echo ($v["user"]); ?>" selected><?php echo str_repeat("|-",$v['level']); echo ($v["user"]); ?></option><?php endforeach; endif; ?>
						</select>
						</span>
					</div>
					<div class="col-3">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						分类名称：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo ($info["user"]); ?>" placeholder="" id="" name="user">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo ($info["cdd"]); ?>" placeholder="" id="" name="cdd">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo ($info["bc"]); ?>" placeholder="" id="" name="bc">
					</div>
					<div class="col-3">
					</div>
				</div>
