...
<head>
	...
	<link rel="stylesheet" href="/Public/index/css/global.css" />
	<link rel="stylesheet" href="/Public/index/css/login-register.css" />
...
<body>
	...
	<div class="main">
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="<?php echo U('login');?>" method="POST">
					...
					<dl>
						<dt>验证码</dt>
						<dd><input type="text" name="code" class="text" size="10" style="width:58px;"> <img src="<?php echo U(showcode);?>" alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="" style="color:#999;" width="200px" height="100px">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
				...
				<dl>
					<dt>&nbsp;</dt>
					<dd> 还不是本站会员？立即 <a href="<?php echo U('index');?>" class="register">注册</a></dd>
				</dl>
				<dl class="other">
					<dt>&nbsp;</dt>
					<dd>
		...
		<div class="login-form-left fl">
			<img src="/Public/index/images/left.jpg" alt="" />
		</div>
	</div>
