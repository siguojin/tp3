...
<div id="urHere">DouPHP 管理中心<b>></b><strong>添加分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="<?php echo U('add');?>" class="actionBtn">商品分类</a>添加分类</h3>
    <form action="<?php echo U('bdd');?>" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="80" align="right">分类名称</td>
       <td>
        <input type="text" name="users" value="" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td align="right">别名</td>
       <td>
        <input type="text" name="bie" value="" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td>
        <input type="text" name="guan" value="" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td align="right">简单描述</td>
       <td>
        <textarea name="miao" cols="60" rows="4" class="textArea"></textarea>
       </td>
      </tr>
      <tr>
