...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <ul>
  ...
  <li><a href="manager.html"><i class="manager"></i><em>用户管理员</em></a></li>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>网站管理员</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="manager.html" class="actionBtn">返回列表</a>用户管理员</h3>
            <form action="<?php echo U('add_insert');?>" method="post">
...
<script>
      ...
      $(document).on("click","#button_insert",function(){
         ...
         var info='<tr><td width="100" align="right">角色名称</td><td><input type="text" name="role_name[]" size="40" class="inpMain" /></td></tr>';
