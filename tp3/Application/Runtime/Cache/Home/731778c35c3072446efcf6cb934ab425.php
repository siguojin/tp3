		...
		<div id="tab-category" class="HuiTab">
			...
			<!-- 	<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo ($info["bie"]); ?>" placeholder="" id="" name="bie">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo ($info["mu"]); ?>" placeholder="" id="" name="mu">
					</div>
					<div class="col-3">
					</div>
				</div>
