...
<head>
	...
	<title>京西商城</title>
	<link rel="stylesheet" href="/Public/qw/style/base.css" type="text/css">
	<link rel="stylesheet" href="/Public/qw/style/global.css" type="text/css">
	<link rel="stylesheet" href="/Public/qw/style/header.css" type="text/css">
	<link rel="stylesheet" href="/Public/qw/style/index.css" type="text/css">
	<link rel="stylesheet" href="/Public/qw/style/bottomnav.css" type="text/css">
	<link rel="stylesheet" href="/Public/qw/style/footer.css" type="text/css">

	<script type="text/javascript" src="/Public/qw/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/Public/qw/js/header.js"></script>
	<script type="text/javascript" src="/Public/qw/js/index.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
	<div class="topnav">
	...
	<div class="colligate w1210 bc mt10">
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items"><?php if(is_array($list)): foreach($list as $key=>$vo): ?><ul>
						<li><a href=""><img src="/Uploads/<?php echo ($vo["files"]); ?>" alt="" /></a></li>
