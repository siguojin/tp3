...
<head>
	...
	<link rel="stylesheet" href="/Public/lunbo/css/base.css" type="text/css" />
	<link rel="stylesheet" href="/Public/lunbo/css/shop_common.css" type="text/css" />
	<link rel="stylesheet" href="/Public/lunbo/css/shop_header.css" type="text/css" />
        <link rel="stylesheet" href="/Public/lunbo/css/shop_home.css" type="text/css" />
        <script type="text/javascript" src="/Public/lunbo/js/jquery.js" ></script>
        <script type="text/javascript" src="/Public/lunbo/js/topNav.js" ></script>
        <script type="text/javascript" src="/Public/lunbo/js/focus.js" ></script>
        <script type="text/javascript" src="/Public/lunbo/js/shop_home_tab.js" ></script>
</head>
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/"><img src="/Public/lunbo/images/logo.png" alt="ShopCZ" /></a><span>ShopCZ</span></h1></div>
	...
	<div class="shop_bd clearfix">
            ...
            <div class="shop_bd_top clearfix">
                ...
                <div class="shop_bd_top_center">
                    ...
                    <div class="xifan_sub_box">
                      ...
                      <div id="xifan_bd1lfimg">
                        <div>
                          <dl class=""></dl>
                          <dl class="">
                          <?php if(is_array($info)): foreach($info as $k=>$v): ?><dt><a href="<?php echo U('index');?>" title="" target="_blank">
                            <img src="/Uploads/<?php echo ($v["image"]); ?>" alt="2011城市主题公园亲子游"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a></h2></dd><?php endforeach; endif; ?>
                          </dl>
                        </div>
                      </div>
                    </div>
                    ...
                    <!-- 图片切换  end --> 
                    <div class="clear"></div>
                    <div class="shop_bd_top_center_hot"><img src="/Public/lunbo/images/index.guanggao.png" /></div>
                </div>
            ...
            <div class="shop_bd_2 clearfix">
                    ...
                    <div class="tuijian_content">
                        <div id="tuijian_content_1" class="tuijian_shangpin" style="display: block;">
                            <ul>
                                      ...
                                      <?php if(is_array($infos)): foreach($infos as $k=>$v): ?><li>
                                    <dl>
                                        <dt><a href="<?php echo U('goods',array('id'=>$v['shopid']));?>"><img src="/Uploads/<?php echo ($v["image"]); ?>" width="200px"  height="150px" /></a></dt>
                                        <dd><a href=""><?php echo ($v["shopname"]); ?></a></dd>
                                        <dd> 商城价：<em><?php echo ($v["model"]); ?></em>元</dd>
                                         </dl>
                ...
                <!-- 首发 -->
                <div class="shop_bd_shoufa"><img src="/Public/lunbo/images/shoufa.jpg" /></div>
                <!-- 首发 End -->
            ...
            <div class="shop_bd_home_block clearfix">
                ...
                <div class="shop_bd_home_block_left">
                    ...
                    <div class="shop_bd_home_block_left_pic">
                        <a href=""><img src="/Public/lunbo/images/web-1-13_53bfbfc958cb55a435545033bd075bf3.png"/></a>
                    </div>
                </div>
                <!-- 左边 End -->
                ...
                <div class="shop_bd_home_block_center">
                    ...
                    <div class="tabs-panel">
                        <ul>
                            <li>
                                <dl>
                                    <dt><a href=""><img src="/Public/lunbo/images/04fb225ea46bd1346f330400eedb7ef2.jpg_small.jpg" /></a></dt>
                ...
                <div class="shop_bd_home_block_right">
                    ...
                    <ol class="saletop-list">
                        <li class="top clearfix">
                            <dl>
                                ...
                                <dd class="nokey">1</dd>
                                <dd class="goods-pic">
                                    <a href=""><span class="thumb size60"><img src="/Public/lunbo/images/3f81874d594894d19150843c42fb1f8e.jpg_small.jpg" /></span></a>
                                </dd>
                    ...
                    <div class="saletop-list_adv_pic"><a href=""><img src="/Public/lunbo/images/web-3-38_ff9bd2d724f7138cec1b1937000f4feb.jpg" /></a></div>
                </div>
                <!-- 右边商品排行 -->
                ...
                <div class="shop_bd_home_block_bottom">
                    <ul class="">
                        <li><a href=""><img src="/Public/lunbo/images/354b80528d2fbeefbab33c563532517e.gif" /></a></li>
                        <li><a href=""><img src="/Public/lunbo/images/1d2dfbead590510046a6522551db8139.gif" /></a></li>
                        <li><a href=""><img src="/Public/lunbo/images/26247430b09daa1b441b46008bfb6e6e.gif" /></a></li>
                        <li><a href=""><img src="/Public/lunbo/images/a0ac8c6d2d3dc1470d5876923182a8e2.gif" /></a></li>
                        <li><a href=""><img src="/Public/lunbo/images/9c5dee77a6ecdafd9e152fed8c6a4e90.gif" /></a></li>
                        <li><a href=""><img src="/Public/lunbo/images/b175883eba95e793affb1b1ebbbf85a5.gif" /></a></li>
                        <li><a href=""><img src="/Public/lunbo/images/6e61a1c953e5bc8c5f1ffdac36862245.gif" /></a></li>
                        <li><a href=""><img src="/Public/lunbo/images/209abd835cd2ce2208f2dc42ba10efb4.gif" /></a></li>
                    </ul>
                </div>
                <!-- 品牌展示 End -->
