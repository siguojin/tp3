...
<div id="urHere">DouPHP 管理中心<b>></b><strong>网站管理员</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="<?php echo U('index');?>" class="actionBtn">轮播图列表</a>   <a href="<?php echo U('bdd');?>" class="actionBtn">添加轮播图</a>
         网站管理员</h3>
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
      <th width="30" align="center">编号</th>
      <th align="left">轮播图名称</th>
      <th align="center">轮播图地址</th>
      <th align="center">轮播图</th>
       <th align="center">轮播图排序</th>
       <th align="center">轮播图状态</th>
      <th align="center">操作</th>
     </tr>
      
     <?php if(is_array($info)): foreach($info as $k=>$vo): ?><tr>
                  <td align="center"><input type="checkbox" ><?php echo ($vo["lun_id"]); ?></td>
                  <td><?php echo ($vo["users"]); ?></td>
                  <td align="center"><?php echo ($vo["emali"]); ?></td>
                  <td align="center">
                  <?php if(is_array($vo["files"])): foreach($vo["files"] as $k=>$v): ?><img src="/Uploads/<?php echo ($v); ?>" width="50px" height="50px"><?php endforeach; endif; ?>


                  </td>
                    <td align="center"><?php echo ($vo["number"]); ?></td>
                      <td align="center"><?php echo ($vo["block"]); ?></td>


                  <td align="center"></a><a href="<?php echo U('show',array('id'=>$vo['id']));?>">添加分类|</a><a href="<?php echo U('update',array('id'=>$vo['id']));?>">编辑</a> | <a href="<?php echo U('delete',array('id'=>$vo['lun_id']));?>">删除</a></td>
