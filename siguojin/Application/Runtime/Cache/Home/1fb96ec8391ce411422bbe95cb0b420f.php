		...
		<div class="login-form fr">
			...
			<div class="form-bd">
				<form action="<?php echo U('add');?>" method="POST">
					...
					<dl>
						<dt>手机好</dt>
						<dd><input type="text" name="phone" class="text"/></dd>
					</dl>
					<dl>
						<dt>验证码</dt>
						<dd><input type="text" name="code" class="text" size="10" style="width:58px;"> <img src="<?php echo U('code');?>" alt="" align=" 
						absmiddle" style="position:relative;top:-2px;"  width="100px" height="40px" /> 
